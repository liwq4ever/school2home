package com.simpletech.school2home.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.simpletech.school2home.dao.SysModuleMapper;
import com.simpletech.school2home.pojo.SysModule;
import com.simpletech.school2home.utils.shiro.KickoutSessionFilter;
import com.simpletech.school2home.utils.shiro.ShiroRealm;
import com.simpletech.school2home.utils.spring.SpringBeanFactoryUtils;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(
        ...
        filterChainDefinitionMap.put("/images/*/*", "anon");
        filterChainDefinitionMap.put("/images/*/*/*", "anon");
        filterChainDefinitionMap.put("/webplugins/**", "anon");
        filterChainDefinitionMap.put("/services/**", "anon");
        filterChainDefinitionMap.put("/services/*/*", "anon");
        filterChainDefinitionMap.put("/services/*/*/*", "anon");
        filterChainDefinitionMap.put("/system/cysyssp/*", "anon");
        filterChainDefinitionMap.put("/business/cyVideo/replayPage", "anon");
        filterChainDefinitionMap.put("/business/cyVideo/videoList", "anon");
        filterChainDefinitionMap.put("/business/cyVideo/videoDataInfo", "anon");
        filterChainDefinitionMap.put("/business/cyCapture/captureInfo", "anon");
        filterChainDefinitionMap.put("/business/cyException/exceptionInfo", "anon");
        filterChainDefinitionMap.put("/business/cyOBD/obdInfo", "anon");
        filterChainDefinitionMap.put("/business/cyWk/WKInfo", "anon");
        filterChainDefinitionMap.put("/business/cyVideo/replayByFlash", "anon");
        filterChainDefinitionMap.put("/business/cyVideo/replayByVlc", "anon");
        filterChainDefinitionMap.put("/business/cyVideo/replayByHik", "anon");
        if (sysModuleMapper == null) {
            sysModuleMapper = (SysModuleMapper) SpringBeanFactoryUtils.getBean(SysModuleMapper.class);
        }
        List<SysModule> sysModuleList = sysModuleMapper.selectList(new SysModule());
        for (SysModule sysModule : sysModuleList) {
            filterChainDefinitionMap.put(sysModule.getUrl(), "perms[" + sysModule.getCode() + "]");
        }
