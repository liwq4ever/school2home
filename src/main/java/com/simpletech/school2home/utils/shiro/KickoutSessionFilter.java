...
import com.simpletech.school2home.utils.result.IResponseStatus;
import com.simpletech.school2home.utils.result.ResponseResult;
import com.simpletech.school2home.utils.result.Result;
import com.simpletech.school2home.utils.result.ResultUtil;
    ...
    protected boolean onAccessDenied(ServletRequest request,
        ...
        if (!subject.isAuthenticated() && !subject.isRemembered()) {
            ...
            if (ShiroFilterUtils.isAjax(request)) {
                ...
                out(response, ResultUtil.error(Integer.valueOf(IResponseStatus.ResponseStatus.MANY_LOGINS.getCode()), "您已在别处登录，请您修改密码或重新登录"));
                return false;
            } else {
                return true;
            }
        ...
        try {
            ...
            logger.error(
                    "控制用户在线数量【lyd-systemManager-->KickoutSessionFilter.onAccessDenied】异常！",
                    e);
            // 重启后，ajax请求，报错：java.lang.ClassCastException:
            // com.lyd.systemManager.pojo.AdminUser cannot be cast to
            // com.lyd.systemManager.pojo.AdminUser
            // 处理 ajax请求
            return isAjaxResponse(request, response);
        }
    }
